...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($pass != $cpass) {
            ...
            $insert = "INSERT INTO users(names, email, contact_number, password) VALUES('$names','$email', '$contact', '$pass')";
...
<body>
    ...
    <div class="form-container">
        ...
        <form action="" method="post">
            ...
            <input type="contact" name="contact" required placeholder="Enter your contact no.">
